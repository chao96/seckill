package com.seckill.server.service.impl;

import com.seckill.model.entity.ItemKill;
import com.seckill.model.entity.ItemKillSuccess;
import com.seckill.model.mapper.ItemKillMapper;
import com.seckill.model.mapper.ItemKillSuccessMapper;
import com.seckill.server.enums.SysConstant;
import com.seckill.server.service.IKillService;
import com.seckill.server.service.RabbitSenderService;
import com.seckill.server.utils.RandomUtil;
import com.seckill.server.utils.SnowFlake;
...
public class KillService implements IKillService {
    ...
    public Boolean killItemV3(Integer killId, Integer userId) throws Exception {
        ...
        if (itemKillSuccessMapper.countByKillUserId(killId, userId) <= 0) {
            ...
            String key = new StringBuilder().append(killId).append(userId).append("-RedisLock").toString();
